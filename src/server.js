...
const { DEFAULT_GAME_ID } = require('./services/gameservice');
...
app.post('/api/game/save', async (req, res) => {
    try {
        ...
        if (result.success) {
            // Broadcast to all clients that the game has been saved
            io.emit('game-saved', {
...
app.post('/api/game/load-state', async (req, res) => {
    try {
